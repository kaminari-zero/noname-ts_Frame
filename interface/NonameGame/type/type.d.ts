 ...
 */
type ContentFunc = ContentFuncByAll | ContentFuncByNormal | ContentFuncByNormal2 | ContentFuncByNormal3 | ContentFuncByNormal4;
...
type ContentFuncByNormal2 = (event: GameEvent, source: Player, player: Player, target: Player ,trigger: GameEvent,result: BaseResultData)=>void;
